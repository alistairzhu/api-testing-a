    ...
    public static void main( String[] args )
    {
     ...
     //   Set setA = new HashSet();
      //  setA.add("WRWERQ");
        ...
        AccountBook accountBook_1 = new AccountBook( "James", "");
      //  setA.add("322332");
     //   AccountBook accountBook_2 = new AccountBook( "Forest", setA);

        try
        {
            // Create
            insertAccountBook( accountBook_1 );
           // insertAccountBook( accountBook_2 );
            System.out.println( "Persons got inserted sucessfully. This is  of CRUD " );
            System.out.println();
            System.out.println( "--------------------------------------------------------------------------------------" );
/*
            // Read(get all)
